    ...
    public class TestNormalDistributionStatisticsWorkflow
    {
        ...
        public async Task TestUnmodifiedDistribution()
        {
            ...
            */
            ...
            #region Operations
            InputOperation<int> opInputSeed = new()
            {
                Id = "1",
                DefaultsTyped = new() { Name = "Seed" }
            };
            InputOperation<int> opInputSampleCount = new()
            {
                Id = "2",
                DefaultsTyped = new() { Name = "SampleCount" }
            };

            SampleNormalOperation opSampleNormal = new()
            {
                Id = "3",
                DefaultsTyped = new() { Mean = 1.0, Deviation = 2.0 }
            };
            ...
            OutputOperation<double> opOutputMu = new()
            {
                Id = "6",
                DefaultsTyped = new() { Name = "Mu" }
            };
            OutputOperation<double> opOutputSigma = new()
            {
                Id = "7",
                DefaultsTyped = new() { Name = "Sigma" }
            };
            #endregion
            ...
            WorkflowOperationConnection connSeedToRandom = new()
            {
                ...
                {
                    Operation = opInputSeed.Id,
                    Field = nameof(InputOperationOut<int>.Value)
                },
                Target = new WorkflowOperationConnectionPoint()
                {
                    Operation = opSampleNormal.Id,
            ...
            WorkflowOperationConnection connCountToRandom = new()
            {
                Source = new WorkflowOperationConnectionPoint()
                {
                    Operation = opInputSampleCount.Id,
                    Field = nameof(InputOperationOut<int>.Value)
                },
                Target = new WorkflowOperationConnectionPoint()
                {
            ...
            WorkflowOperationConnection connMeanToMu = new()
            {
                ...
                Target = new WorkflowOperationConnectionPoint()
                {
                    Operation = opOutputMu.Id,
                    Field = nameof(OutputOperationIn<double>.Value)
                }
            };
