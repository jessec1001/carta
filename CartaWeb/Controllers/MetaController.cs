...
namespace CartaWeb.Controllers
{
    ...
    public class MetaController : ControllerBase
    {
        ...
        public ActionResult<Dictionary<string, DiscriminantEntry>> GetActions()
        {
            ...
            if (Discriminant.TryGetTypes<ActionBase>(out IEnumerable<DiscriminantType> actionTypes))
            {
        ...
        public ActionResult<ActionBase> GetActionDefault([FromRoute] string actor)
        {
            // Generate the default value for an action if the action is valid.
            if (Discriminant.TryGetValue<ActionBase>(actor, out ActionBase actorValue))
        ...
        public ActionResult<JsonSchema> GetActionSchema([FromRoute] string actor)
        {
            ...
            if (Discriminant.TryGetType<ActionBase>(actor, out DiscriminantType actorType))
            {
