...
namespace CartaCore.Operations.Attributes
{
    ...
    public interface IOverrideConversionAttribute
    {
        ...
        /// The only input fields that are considered are those that are returned from <see cref="Operation.GetInputFields(OperationJob)"/>.
        /// </summary>
        ...
        /// The only output fields that are considered are those that are returned from <see cref="Operation.GetOutputFields(OperationJob)"/>.
        /// </summary>
        /// <param name="operation">The executing operation.</param>
        /// <param name="field">The description of the field.</param>
